...
def data_updater(symbol=None, isAll=False):
    ...
    for sym in symbol:
        ...
        if KlineAllSymbol.objects.filter(symbol=sym).exists():
            ...
            deltaDate =  datetime.datetime.fromtimestamp(endDateTimesatmp/1000) - datetime.datetime.fromtimestamp(starteDateTimeStamp/1000)
            if deltaDate.days >= 1:
            ...
            print(deltaDate.total_seconds()/60)
